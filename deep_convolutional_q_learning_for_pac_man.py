...
class Agent():   # remeber that there is no state_size
...
for episode in range(1, number_episodes + 1):
  ...
  if np.mean(scores_on_100_episodes) >= 100.0:                # I set the limit to be 100, it is supposed to be more, around 500, but I do not have a powerful enough system to perform it nor the money to buy units, hehe
